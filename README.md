...
**[Live site](http://sweta.me/)**

This repo contains code of Sweta's Room Folio. If you're interested, learn how to create a porfolio like this [here](https://youtu.be/AB6sulUMRGE)!! It's beginner friendly!
...
This project showcases a fully interactive 3D room where different objects act as navigation elements (Projects, About, Contact, etc.). It focuses on combining 3D design (Blender) with web interactivity (Three.js + GSAP).
